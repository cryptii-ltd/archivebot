...
const config: Config = {
  ...
  theme: {
    colors: {
      ...
      'purple-100': 'hsl(234, 86%, 76%)',
      'purple-200': 'hsl(234, 82%, 72%)',
      'purple-300': 'hsl(234, 78%, 68%)',
      'purple-400': 'hsl(234, 74%, 64%)',
      'purple-500': 'hsl(234, 70%, 60%)',
      'purple-600': 'hsl(234, 66%, 56%)',
      'purple-700': 'hsl(234, 62%, 52%)',
      'purple-800': 'hsl(234, 58%, 48%)',
      'purple-900': 'hsl(234, 54%, 44%)',
    },
    extend: {},
  },
  plugins: [],
