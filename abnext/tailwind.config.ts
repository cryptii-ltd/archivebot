...
const config: Config = {
  ...
  theme: {
    colors: {
      ...
      'black-100': 'hsl(240, 12%, 17%)',
      'black-200': 'hsl(240, 12%, 15%)',
      'black-300': 'hsl(240, 12%, 13%)',
      'black-400': 'hsl(240, 12%, 11%)',
      'black-500': 'hsl(240, 12%, 9%)',
      'black-600': 'hsl(240, 12%, 7%)',
      'black-700': 'hsl(240, 12%, 5%)',
      'black-800': 'hsl(240, 12%, 3%)',
      'black-900': 'hsl(240, 12%, 0%)',
